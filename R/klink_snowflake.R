...
#' @description Enables users to create read-only connections to Kellogg 
#' Snowflake databases
#'
...
#'
#' @param environment character string containing desired environment. Currently 
#'  only "DEV" and "PROD" are supported.
#' @param database character string containing exact name of desired database. 
