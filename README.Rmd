...
### zoltar
The klink connection functions are wrappers that utilize an internal API called zoltar in order to simplify the user experience. This is achieved by leveraging the zoltar API and making assumptions about the connection that should be formed based on the user inputs.
