...
## How to Install
Currently, the easiest way to install the klink package is to create install from the public GitHub repo:
...
In the future we may host these types of packages in our internal RStudio Package Manager environment.
...
```{r klink_s3R, eval=FALSE, include=TRUE}
library(klink)
library(aws.s3)
...
If you would like to override these assumptions zoltar is the solution.
